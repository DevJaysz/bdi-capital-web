...
function Hero() {
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-start bg-[#111111] text-white px-4 pt-16">
      {/* Logo */}
      <img
        src={Logo}
        alt="Logo"
      ...
      {/* Text and Arrow */}
      <div className="flex flex-col items-center justify-center text-center pt-8 space-y-4">
