import pictureLeft from "../../assets/background/office-long-1-left.png";
import pictureRight from "../../assets/background/office-long-1-right.png";
  ...
  return (
    <section className="h-screen flex items-center">
      <div className="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
        ...
        <div className="font-light text-gray-500 sm:text-lg dark:text-gray-400 font-centuryGothic">
